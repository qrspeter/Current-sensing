...
void interface_testFrame::Meas_start(wxCommandEvent &event)
{
    ...
    // wxPen::wxPen(const wxColour&, int, int)' is deprecated: use wxPENSTYLE_XXX constants
...
void interface_testFrame::Transient_start(wxCommandEvent &event)
{
    ...
    frameworkVector -> SetPen(wxPen(wxColor(0xFF, 0x00, 0x00), 5, wxSOLID));  // 2 for SetContinuity(true) and 5 for false
