...
struct DAC_voltage drain_bias =  {0, 0}; // потом это должен быть не 0, а ~4096/2=2048 = x800 = x08 + x00, а то будет висеть минус ХЗ
struct DAC_voltage gate_bias  =  {0, 0}; // потом это должен быть не 0, а ~4096/2=2048 = x800, а то будет висеть минус ХЗ
